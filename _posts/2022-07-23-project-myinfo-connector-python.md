...
Myinfo는 PKI Digital Signature를 필요로 한다. 해당 문서에서는 python에서 PKI를 사용하는 방법만을 다루기 때문에 PKI에 대한 더 자세한 설명은 링크로 첨부하겠다. [[Security] Digital Certificate](https://https://https://leeleelee3264.github.io/old-blog/infra/2022/06/15/digital-certificate-part-one.html)
